...
public:
	...
	std::unique_ptr<DirectX::IEffect> poligon_effect;

	std::unique_ptr<DirectX::IEffect> line_effect;
	...
	Microsoft::WRL::ComPtr<ID3D11RasterizerState> rsPoligon;

	Microsoft::WRL::ComPtr<ID3D11RasterizerState> rsLine;
...
public:
	...
	Microsoft::WRL::ComPtr<ID3D11Texture2D> depthStencilTStaging;
	Microsoft::WRL::ComPtr<ID3D11Texture2D> colorTStaging;
